    ...
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            <Label>Contract clause references (citations)</Label>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 min-w-0">
            ...
            <table className="w-full text-sm min-w-[320px]">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-right py-1 whitespace-nowrap">Qty</th>
                  <th className="text-right py-1 whitespace-nowrap">Unit</th>
                  <th className="text-right py-1 whitespace-nowrap">{t('co.unitPrice')}</th>
                  <th className="text-right py-1 whitespace-nowrap">Amount</th>
                </tr>
              </thead>
              <tbody>
          ...
          <form onSubmit={addItem} className="flex flex-wrap gap-2 pt-2">
            <Input name="newDescription" placeholder="Description" className="min-w-0 flex-1 sm:w-48 max-w-full" />
            <Input name="newQuantity" type="number" defaultValue={1} className="w-14 sm:w-16" />
            <Input name="newUnit" placeholder="LS" defaultValue="LS" className="w-12 sm:w-16" />
