...
/** Google & GitHub OAuth buttons. Use on login and register pages. */
    ...
    <div className="space-y-2">
      <div className="relative my-4">
        <span className="bg-card absolute inset-0 flex items-center justify-center">
          <span className="bg-muted px-2 text-xs text-muted-foreground">{t('auth.orContinueWith')}</span>
        </span>
      </div>
      <div className="grid grid-cols-1 gap-2">
        ...
        <Button
          ...
          variant="outline"
          className="w-full"
          onClick={() => signIn('github', { callbackUrl: '/org' })}
        >
